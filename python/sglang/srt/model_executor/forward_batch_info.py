...
class ForwardBatch(ForwardBatchDeepSeekMHAMixin):
    ...
    def prepare_mlp_sync_batch(self, model_runner: ModelRunner):
        ...
        if (
            ...
            # TARGET_VERIFY counts as extend, so a verify step can reach the
            # extend conversion below. Hybrid-SSM families keep verify batches
            # in verify layout; this includes their MTP draft workers, whose
            # mamba-less "*E" pattern makes mambaish_config return None.
